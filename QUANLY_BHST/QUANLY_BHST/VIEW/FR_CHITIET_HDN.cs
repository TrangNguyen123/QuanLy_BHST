...
{
    public partial class FR_CHITIET_HDN : Form
    {
        CT_HOADONNHAP_C Obj_c =  new CT_HOADONNHAP_C();
        CHITIET_HDN Obj = new CHITIET_HDN();
        int flag = 0;
        DataTable Obj_tb = new DataTable();
        public FR_CHITIET_HDN()
        {
            InitializeComponent();
        }

        private void FR_CHITIET_HDN_Load(object sender, EventArgs e)
        {
        ...
        private void Bingding()
        {
            ...
            cmbDongia.DataBindings.Add("Text", dgvCT_HDBAN.DataSource, "dongianhap");
        ...
        private void Loat_MaHD()
        {
            ...
            cmbMaHD.DisplayMember = "mahoahodon";
        ...
        private void Loat_Dongiaban()
        {
            ...
            cmbDongia.DisplayMember = "dongianhap";
            cmbDongia.ValueMember = "mavach";
        }
        private void Gan_Obj(CHITIET_HDN obj)
        {
            obj.Mavach = cmbTenHH.SelectedValue.ToString();
            obj.Soluong = int.Parse(txtSoluong.Text.Trim());
            obj.Dongianhap = float.Parse(cmbDongia.Text.Trim());
